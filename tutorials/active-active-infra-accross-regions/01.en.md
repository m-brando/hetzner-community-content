...
This infrastructure can be modified at any time. You can add a new region, scale nodes up or down within existing regions, integrate another cloud provider, or even attach physical machines to the cluster.
...
Through this tutorial, we demonstrate how to provision a Kubernetes cluster across two Hetzner regions using `Claudie` to manage the infrastructure.
